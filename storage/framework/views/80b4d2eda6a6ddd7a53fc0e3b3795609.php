...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['label', 'name', 'options' => [], 'value' => '', 'required' => false]));
...
foreach (array_filter((['label', 'name', 'options' => [], 'value' => '', 'required' => false]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php /**PATH C:\xampp\htdocs\LTP3-CRUD-Laravel\resources\views/components/form-select.blade.php ENDPATH**/ ?>